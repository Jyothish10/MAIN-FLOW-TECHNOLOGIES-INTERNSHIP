...
def bill_area():
    if nameEntry.get()=="" or phoneEntry.get()=="":
        ...
        textArea.delete(1.0,END)
        textArea.insert(END,"\t**Welcome to Leo Resturant**\n")
        ...
        if vegburEntry.get()!="0":
            textArea.insert(END,f" Veg Burger\t\t   {vegburEntry.get()}\t\t {vegburgerprice} Rs\n")
      ...
      # bill printing of pizza
        ...
        if otcEntry.get()!="0":
            textArea.insert(END,f" chicken Spl Pizza\t\t     {otcEntry.get()}\t\t {otcpizzprice} Rs\n")
...
root=Tk()
root.title("LEO Resturant")
root.geometry("1350x815")

#icon will be placed here 
headingLabel=Label(root,text="LEO Resturant Billing System",font=("times new roman",30,"bold"),bg="aquamarine1",fg="gold",bd=14,relief=GROOVE)# can be editable after also will ask from all 
...
vegburLabel=Label(burgerFrame,text="Veg Burger",font=("times new roman",14,"bold"),bg="gray20",fg="white")
...
otcLabel=Label(pizzaFrame,text="Chicken Spl Pizza",font=("times new roman",14,"bold"),bg="gray20",fg="white")
...
billmenuFrame=LabelFrame(root,text="Bill Menu",font=("times new roman",14,"bold"),fg="gold",bd=8,relief=GROOVE,bg="lightcyan1")
billmenuFrame.pack()


#*****************Final price of burgers******************
burgerPriceLabel=Label(billmenuFrame,text="Burger Price",font=("times new roman",14,"bold"),bg="grey20",fg="white")
...
pizzaPriceLabel=Label(billmenuFrame,text="Pizza Price",font=("times new roman",14,"bold"),bg="grey20",fg="white")
...
coldDrinksPriceLabel=Label(billmenuFrame,text="Shakes Price",font=("times new roman",14,"bold"),bg="aquamarine1",fg="white")
